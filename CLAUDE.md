...
- Tailwind CSS v4
- Reka UI components (shadcn/ui alternative for Vue)
...
- Controllers in `app/Http/Controllers/` with Auth and Settings subdirectories
- Models in `app/Models/` (currently just User model)
- Middleware for appearance handling and Inertia requests
- Route files: `web.php`, `auth.php`, `settings.php`
...
- Pages in `resources/js/pages/` organized by feature (auth, settings)
- Layouts in `resources/js/layouts/` with nested layout system
